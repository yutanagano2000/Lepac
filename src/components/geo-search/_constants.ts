...
export const TEMPLATES = {
  宅地造成等工事規制区域:
    "宅地造成規制区域。造成の規模によっては許可申請が必要。現調結果次第で判断いたします。",
  特定盛土等規制区域:
    "特定盛土規制区域。造成の規模によっては届出 / 許可申請が必要。現調結果次第で判断いたします。",
};
...
export const LAWS: Law[] = [
  ...
  { id: 19, name: "環境影響評価法・条例" },
  {
    id: 20,
    name: "消防法",
    fixedText: "低圧の為、消防署への届出が必要な機器設置なく、該当しません。",
  },
  {
    id: 21,
    name: "振動規制法",
    fixedText: "特定施設を設置しないため、該当しません。",
  },
  {
    id: 22,
    name: "道路法",
    fixedText:
      "工事区域に道路が無い為、道路使用許可が占用許可の必要な行為は予定されていません。",
  },
  {
    id: 23,
    name: "廃棄物の処理及び清掃に関する法律",
    fixedText:
      "敷地内の残置物及び工事で発生した産廃物については適正に処理します。",
  },
];

// 担当部署にお問い合わせのアラートを表示する法律ID
...
// 中国四国地方の都道府県
export const CHUSHIKOKU_PREFECTURES = [
  "岡山県",
  "広島県",
  "山口県",
  "鳥取県",
