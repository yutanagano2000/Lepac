...
import { MONTHS, MANAGER_OPTIONS, PHASES } from "./_constants";
import type { PhaseKey } from "./_constants";
import type { ProjectWithProgress, TimelineViewProps, AlertLevel } from "./_types";
